# -*- coding: utf-8 -*-
"""
Danube Tiscza Interfluve (homogeneous case)
Author: Someone
Date: Some day
Place: Some place
...
#Description: To solve steady unconfined aquifer in Danube-Tiscza Interfluve
...
K      = 2e-2*cm2m           #Hydraulic conductivity of the segment [m/s]
